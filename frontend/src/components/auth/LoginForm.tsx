        ...
        <form>
            <label className="flex flex-col items-center">
                ...
                <div className="flex flex-col mt-6 w-96">
                    ...
                    <button type="submit" className="bg-zinc-100 rounded-[30px] text-lg font-bold p-4 mt-4 bg-blue-200">Войти</button>
                    ...
                    <button className="bg-zinc-100 rounded-[30px] text-lg font-bold p-4 mt-4 bg-blue-200" onClick={handleSwitchToRegister}>Зарегистрироваться</button>
                </div>
            </label>
        </form>
    );
